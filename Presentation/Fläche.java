...
public class Fläche extends Kaestchen {

    private static final int SIZE = 24;
    private static final int FOODOFFSET = 5;
    private static final int INITIAL_POWER = 16;
    ...
    public void initialize() {
        // food line
        farbeSetzen(SIZE/2+1+1, SIZE/2+1, Color.ORANGE);
        farbeSetzen(17, 8, Color.ORANGE);

        // food random
        /* farbeSetzen(random.nextInt(SIZE)+1, random.nextInt(SIZE)+1, Color.ORANGE); */
